...
conv3_weight = tf.Variable(tf.truncated_normal([4, 4, conv3_features, conv3_features],
                                               stddev=0.1, dtype=tf.float32))
...
def my_conv_net(input_data):
    ...
    max_pool3 = tf.nn.max_pool(relu3, ksize=[1, max_pool_size3, max_pool_size3, 1],
                               strides=[1, max_pool_size3, max_pool_size3, 1], padding='VALID')
